...
set_alias() {
  ...
  abbrev-alias env='env | fzf | xargs echo -e'
  ...
  abbrev-alias glp='git log --pretty=format:"%C(auto) %h %>(13,trunc)%ch %Cblue%cn%C(auto)%d %s"' # check https://git-scm.com/docs/pretty-formats
  ...
  abbrev-alias tje='task jira -epic'
  abbrev-alias tjo='task jopen '
  abbrev-alias tjc='task jcopy '
  abbrev-alias tjs='task jsync '
  abbrev-alias ts='task '
  ...
  abbrev-alias tw='taskwrap'

  # Jira & Thunderbird sync
  abbrev-alias jtw='jira-taskwarrior --no-dry-run'
  abbrev-alias jtwk='jira-taskwarrior --no-dry-run -k '
  abbrev-alias jtwd='jira-taskwarrior'
  abbrev-alias jwl='jira-workload'
  abbrev-alias tb2t='tb2task'
  abbrev-alias tb2td='tb2task --dry-run'
